                ...
                <form onSubmit={handleNext}>
                  <div className='grid md:grid-cols-1 gap-4 w-full py-2'>
                      ...
                      <div className='flex flex-col'>
                        ...
                        <input
                          className='border-2 rounded-[4px] p-3 flex border-gray-300'
                          type="number"
                          id="idnumber"
                          name="idnumber"
                      ...
                      {/* <NavLink  to='/accountVerification' > */}
                        <button disabled = {isNextDisabled}  type="submit" className='w-40 text-xl rounded-[4px]  p-4 text-gray-100 mt-4 bg-[#08AEEA]'>
                         Next
                      </button>
                   {/* </NavLink> */}
                  </div>
